package org.xdef.transform.tool;
...
public class GenReportTables {
	...
	public static void main(String... args) {
		String packageName = "org.xdef.transform.xsd.msg";
		File resourceDir =
			new File("xdef-transform-xsd/src/main/resources/org/xdef/msg/");
		if (!resourceDir.exists() || !resourceDir.isDirectory()) {
			throw new RuntimeException("Resources directory is not available: "
				+ resourceDir.getAbsolutePath());
		}
		File srcDir = new File("xdef-transform-xsd/src/main/java/org/xdef/transform/xsd/msg/");
