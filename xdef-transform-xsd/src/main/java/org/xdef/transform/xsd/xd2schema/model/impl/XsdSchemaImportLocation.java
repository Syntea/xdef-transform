...
public class XsdSchemaImportLocation {
    ...
    /**
     * XML Schema document source X-Definition
     */
    private final String xDefName;
    ...
    public XsdSchemaImportLocation(String namespaceUri, String fileName, @Nullable String xDefName) {
    ...
    public Optional<String> getXDefName() {
        return Optional.ofNullable(xDefName);
    }
