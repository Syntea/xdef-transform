...
public class XDefExtendedXd2SchemaTest extends AbstractXd2SchemaTransformSuite {
    ...
    public void extended_SoapRequestD6WS() {
        initCaseDirs(SUITE_NAME, "SoapRequestD6WS");
        convertXd2SchemaNoRef("SoapRequestD6WS", null, null);
    }

    @Test
    public void extended_ChildAttr2Child() {
        initCaseDirs(SUITE_NAME, "ATTR_CHLD_to_CHLD");
        convertXd2SchemaNoRef("ATTR_CHLD_to_CHLD", Collections.singletonList("ATTR_CHLD_to_CHLD_valid_1"), null);
    }

    @Test
    public void extended_ChildAttr2Attr() {
        initCaseDirs(SUITE_NAME, "ATTR_CHLD_to_ATTR");
        convertXd2SchemaNoRef("ATTR_CHLD_to_ATTR", Collections.singletonList("ATTR_CHLD_to_ATTR_valid_1"), null);
    }

    @Test
    public void extended_ChildAttr2ChildAttr() {
        initCaseDirs(SUITE_NAME, "ATTR_CHLD_to_ATTR_CHLD");
        convertXd2SchemaNoRef("ATTR_CHLD_to_ATTR_CHLD", Collections.singletonList("ATTR_CHLD_to_ATTR_CHLD_valid_1"), null);
    }

    @Test
    public void extended_Attr2Attr() {
        initCaseDirs(SUITE_NAME, "ATTR_to_ATTR");
    ...
    public void extended_Attr2Child() {
        initCaseDirs(SUITE_NAME, "ATTR_to_CHLD");
        convertXd2SchemaNoRef(
    ...
    public void extended_Attr2ChildAttr() {
        initCaseDirs(SUITE_NAME, "ATTR_to_ATTR_CHLD");
        convertXd2SchemaNoRef(
    ...
    public void extended_Child2Attr() {
        initCaseDirs(SUITE_NAME, "CHLD_to_ATTR");
        convertXd2SchemaNoRef(
    ...
    public void extended_Child2ChildAttr() {
        initCaseDirs(SUITE_NAME, "CHLD_to_ATTR_CHLD");
        convertXd2SchemaNoRef(
    ...
    public void extended_Child2Child() {
        initCaseDirs(SUITE_NAME, "CHLD_to_CHLD");
        convertXd2SchemaNoRef(
    ...
    public void extended_BasicTest() {
        initCaseDirs(SUITE_NAME, "basicTest");
        convertXd2SchemaNoRef(
                "basicTest",
    ...
    public void extended_B1_common() {
        initCaseDirs(SUITE_NAME, "B1_common");
        convertXd2SchemaNoRef(
                "B1_common",
    ...
    public void extended_DateTime() {
        initCaseDirs(SUITE_NAME, "dateTimeTest");
        convertXd2SchemaNoRef(
    ...
    public void extended_Declaration() {
        initCaseDirs(SUITE_NAME, "declarationTest");
        convertXd2SchemaNoRef(
                "declarationTest",
    ...
    public void extended_Namespace1() {
        initCaseDirs(SUITE_NAME, "namespaceTest");
        convertXd2SchemaNoRef(
    ...
    public void extended_Namespace2() {
        initCaseDirs(SUITE_NAME, "namespaceTest2");
        convertXd2SchemaNoRef(
    ...
    public void extended_Namespace3() {
        initCaseDirs(SUITE_NAME, "namespaceTest3");
        convertXd2SchemaNoRef(
    ...
    public void extended_Namespace4() {
        initCaseDirs(SUITE_NAME, "namespaceTest4");
        convertXd2SchemaNoRef(
    ...
    public void extended_SimpleModelTest() {
        initCaseDirs(SUITE_NAME, "simpleModelTest");
        convertXd2SchemaNoRef(
                "simpleModelTest",
